...
The 'northwind_lakeflow_pipeline' project was generated by using the lakeflow-pipelines template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] northwind_lakeflow_pipeline_etl` to your workspace.
